    ...
    return (
        <div>
            <motion.section
                ...
                className="container mx-auto text-center items-center px-4 sm:px-8">
                {/* Intro Section */}
                <motion.div
                    className="space-y-6 my-12 md:my-32 text-white rounded-xl p-8 shadow-lg"
                    initial={{ opacity: 0, y: 50 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8 }}>
                    <div className="text-center space-y-4">
                        <h1 className="text-4xl md:text-6xl text-cyan-100 font-extrabold tracking-tight drop-shadow-lg">
                            Ansh Maurya
                        </h1>
                        <h2 className="text-xl md:text-2xl font-medium opacity-90">
                            Frontend Developer | Innovator | Creator
                        </h2>
                    </div>
                    <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
                        <a
                            ...
                            target="_blank"
                            className="inline-flex items-center justify-center rounded-full bg-white text-indigo-700 font-semibold px-6 py-3 text-sm md:text-md shadow-md hover:shadow-xl transition-transform duration-300 transform hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white">
                            Download Resume
                        </a>
                        <a
                            ...
                            className="text-white hover:text-indigo-300 transition-transform duration-300 transform hover:scale-125">
                            <CiLinkedin className="h-10 w-10" />
                        </a>
                        <a
                            href="https://github.com/ansh9918"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-white hover:text-indigo-300 transition-transform duration-300 transform hover:scale-125">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm md:text-md opacity-80">
                            &#34; Turning ideas into reality, one line of code
                            at a time.&#34;
                        </p>
                    </div>
                </motion.div>
                ...
                {/* About Me Section */}
                <motion.div
                    className="my-16 md:my-32 space-y-4"
                    id="abousection">
                    ...
                    <motion.div className="mt-4 flex flex-col gap-10 px-4 md:px-32 py-10 h-auto md:flex-row items-center">
                        ...
                        <motion.div
                            ...
                            <motion.div className="flex flex-col md:flex-row justify-between gap-8 space-y-6 my-8 md:space-y-0 md:space-x-8">
                                {/* Internships */}
                                <div className="flex flex-col md:w-1/2 transition-all duration-300 items-center justify-center border border-gray-700 hover:border-cyan-100 hover:scale-110 rounded-2xl p-6 md:px-12 space-y-2">
                                    ...
                                    <ul className="text-center">
                                        ...
                                        <li className="flex items-center justify-center gap-2">
                                            Internshala | May 2022 - July 2022{" "}
                                            <a
                                ...
                                <div className="flex flex-col md:w-1/2 transition-all duration-300 items-center justify-center border border-gray-700 hover:border-cyan-100 hover:scale-110 rounded-2xl p-6 md:px-12 space-y-2">
                                    ...
                                    <p className="text-center text-cyan-100">
                                        B.E. Bachelor&apos;s Degree 2020 - 2024
                                        <br />
                            ...
                            <motion.div className="flex flex-col md:flex-row justify-between gap-8 space-y-6 my-8 md:space-y-0 md:space-x-8">
                                ...
                                {/* NGO Work */}
                                <div className="flex flex-col md:w-1/2 items-center justify-center transition-all duration-300 border border-gray-700 hover:border-cyan-100 hover:scale-110 rounded-2xl p-6 md:px-12 space-y-2">
                                    <MdPeopleAlt className="w-9 h-9 mx-auto text-cyan-100" />
                                    <h3 className="text-lg font-medium text-cyan-100">
                                        Animal Trust
                                    </h3>
                                    <p className="text-center text-cyan-100">
                                        I have been working with local NGOs to
                                        provide food and shelter to stray
                                        animals. We also treat injured animals
                                        with severe wounds.
                                    </p>
                                </div>
                            </motion.div>
