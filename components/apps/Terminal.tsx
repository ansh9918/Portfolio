...
export default function Terminal() {
  ...
  const executeCommand = (cmd: string) => {
    ...
    setHistory((prev) => [...prev, `ansh@macbook-pro ~ $ ${cmd}`, ""]);
    ...
    switch (mainCommand) {
      ...
      case "contact":
        setHistory((prev) => [
          ...
          "LinkedIn: linkedin.com/in/ansh-maurya-268235211/",
          "Website: anshportfolio-swart.vercel.app",
          "",
        ]);
        break;
  ...
  return (
    <div
      ...
      <div className="flex">
        <span className="mr-2">ansh@macbook-pro ~ $</span>
        <input
          ref={inputRef}
          type="text"
          value={input}
          ...
          className="flex-1 bg-transparent outline-hidden caret-green-400 text-green-400"
          autoFocus
        />
      </div>
    </div>
