            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="bg-gray-100 p-4 rounded-lg flex items-center justify-between">
                  ...
                  <button className="px-4 py-2 bg-blue-500 text-white rounded-sm hover:bg-blue-600">Check Now</button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gray-100 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <select className="px-3 py-1 border rounded-sm">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <div className="border-2 border-blue-500 p-1 rounded-lg">
                    <div className="bg-white w-32 h-24 rounded-sm flex flex-col">
                  ...
                  <div className="border-2 border-gray-300 p-1 rounded-lg">
                    <div className="bg-gray-800 w-32 h-24 rounded-sm flex flex-col">
                  ...
                  <div className="border-2 border-gray-300 p-1 rounded-lg">
                    <div className="bg-linear-to-b from-white to-gray-800 w-32 h-24 rounded-sm flex flex-col">
                      <div className="h-6 bg-linear-to-b from-gray-200 to-gray-700 rounded-t"></div>
                      <div className="flex-1"></div>
                    </div>
