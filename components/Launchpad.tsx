...
const Launchpad = ({ onAppClick, onClose }: LaunchpadProps) => {
      ...
      <div
        ...
        <div className="relative w-64 mx-auto mb-12">
          <input
            type="text"
            placeholder="Search"
            className="w-full bg-white/20 backdrop-blur-md text-white border-0 rounded-full py-2 pl-10 pr-4 focus:outline-hidden focus:ring-2 focus:ring-white/50"
            value={searchTerm}
