  ...
  return (
    <div
      ...
      <div className="flex-1 flex items-center">
        <button
          className="flex items-center mr-4 hover:bg-white/10 px-2 py-0.5 rounded-sm"
        ...
        {activeWindow && (
          <button
            className={`mr-4 font-medium hover:bg-white/10 px-2 py-0.5 rounded-sm ${activeMenu === "app" ? "bg-white/10" : ""}`}
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="relative">
          <div className="w-6 h-3 border border-current rounded-xs relative">
            <div
            ...
            <div
              ...
              <div className="flex items-center justify-between">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-11 h-6 bg-gray-500 peer-focus:outline-hidden rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-500"></div>
                </label>
              </div>
            </div>
          )}
